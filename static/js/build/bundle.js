...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    key: "_updateView",
	    value: function _updateView(url) {
	      if (url !== '') {
	        this.setState({
	          url: url
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideImage = function (_Component) {
	  ...
	  function SideImage() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SideImage).apply(this, arguments));
	  }
	...
	var Nav = function (_Component2) {
	  ...
	  function Nav() {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Nav).call(this));
	  ...
	  _createClass(Nav, [{
	    ...
	    value: function _displayImages() {
	      ...
	      return this.props.photos.map(function (image) {
	        return _react2.default.createElement(SideImage, {
	          id: image.id,
	          key: image.id,
	          url: image.image,
	          photo: image,
